...
// Function to handle rearranging names with compound last names
...
// Log the rearranged names to the console
...
// **Operations**
// 1. Sum of all numeric values from the var or const declarations
const sumOfNumericValues = persona1.age + persona2.age;
console.log(`Sum of numeric values: ${sumOfNumericValues}`);

// 2. Add the ages of both personas. Subtract the length of Persona 1's name from the result, then multiply by the length of Persona 2's name.
const result2 = (persona1.age + persona2.age - persona1NameLength) * persona2NameLength;
console.log(`Result 2: ${result2}`);

// 3. Raise the length of Persona 1's address to the power of Persona 2's address length.
